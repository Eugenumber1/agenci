        ...
        <div className="flex flex-wrap items-center 2xl:w-[1450px] xl:w-[1300px] w-11/12 mx-auto md:pl-4 xl:pr-16 xl:pl-16">
          ...
          <div className="w-3/4 mx-auto lg:w-1/2 flex flex-wrap lg:-mx-4 sm:pr-8 lg:pt-10 justify-center lg:pl-4 xl:px-8">
            <div className="mb-8 lg:mb-0 w-full sm:w-1/2 px-2 lg:px-0">
              <div className="mb-4 py-3 pl-3 pr-2 rounded relative">
...
<path d="M14 17C14 13.134 17.134 10 21 10H78C81.866 10 85 13.134 85 17C85 20.866 81.866 24 78 24H21C17.134 24 14 20.866 14 17Z" fill="#A2A3F7"/>
    ...
    <div className="absolute inset-0 flex flex-col justify-center" style={{ padding: '10px' }}>
                <div className="text-zinc-300 text-4xl font-bold font-['Fira Sans']" style={{ marginBottom: '20px', marginLeft: "10px" }}>AI Strategy</div>
                <div className="text-gray-100 text-[20px] font-normal font-['IBM Plex Sans']" style={{ maxWidth: '100%', marginLeft: "10px" }}>
...
<div className="w-[244.55px] text-zinc-300 text-5xl font-bold font-['Fira Sans']">AI Strategy</div>
<div className="w-[376px] h-[228px] text-gray-100 text-[32px] font-normal font-['IBM Plex Sans']">
  <p>Every project starts with a goal. Every goal should align with the strategy. We will develop the latter for you</p>.</div>
              </div> */}
